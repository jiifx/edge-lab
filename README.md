...
[`samples/sample-1000-trades.json`](samples/sample-1000-trades.json) is a 1,000-trade futures journal with
a modest, real edge. In the app: **Journal → Import → Merge**, then pick **Sample 50k** in Account scope.
It is generated by [`samples/generate_sample.py`](samples/generate_sample.py).
